        ...
        <form className="flex flex-col gap-5" onSubmit={(e) => e.preventDefault()}>
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-11 pr-4 py-3.5 rounded-xl  bg-gray-300 border border-gray-400 md:border-gray-200 focus:outline-none focus:border-indigo-400 focus:ring-4 focus:ring-indigo-50 transition text-sm placeholder-gray-400"
                required
              />
            </div>
          </div>
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-11 pr-12 py-3.5 rounded-xl bg-gray-300 border border-gray-400 md:border-gray-200 focus:outline-none focus:border-indigo-400 focus:ring-4 focus:ring-indigo-50 transition text-sm placeholder-gray-400"
                required
              />
              <button
                type="button"
          ...
          <div className="flex items-center justify-between">
            <label className="flex items-center gap-2 cursor-pointer group">
              ...
              />
              <span className="text-sm text-gray-600 group-hover:text-gray-900 transition">Ingat saya</span>
            </label>
            <Link href="/forgot-password" className="text-sm text-indigo-500 hover:text-indigo-600 transition font-medium">
              Lupa Password?
            </Link>
          </div>

          {/* --- SPACER (PENTING) ---
        Elemen ini akan mengambil semua sisa ruang kosong di tengah 
        sehingga mendorong konten di bawahnya ke titik paling bawah.
      */}
        <div className="flex-1 min-h-35 md:hidden" />
          ...
          <div className="flex flex-col gap-4 mt-2">
            ...
            <p className="text-center text-sm text-gray-500">
              Belum punya akun?{" "}
              <Link href="/auth/register" className="text-indigo-500 font-semibold hover:text-indigo-600 transition">
                Daftar Sekarang
              </Link>
            </p>
          </div>

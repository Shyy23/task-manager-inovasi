...
export default function RegisterPage() {
  ...
  return (
    ...
    <div className="grid grid-cols-1 lg:grid-cols-12 bg-transparent lg:bg-white lg:bg-linear-to-br lg:from-teal-50 lg:via-white lg:to-indigo-50 lg:shadow-2xl lg:rounded-3xl overflow-hidden">
      {/* ─────────────────────────────────────────
        ...
        <div className="relative z-10 w-full max-w-sm flex flex-col items-center gap-8">
          ...
          <div className="text-center">
            ...
            <p className="mt-3 text-indigo-100 text-sm leading-relaxed">
              Satu platform untuk kelola semua kebiasaan & task kamu dengan
              disiplin tinggi.
            </p>
          </div>
          ...
          <ul className="flex flex-col gap-4 w-full">
            {features.map((f, i) => (
              <li
                key={i}
                className="flex items-center gap-4 bg-white/10 rounded-2xl px-5 py-4 backdrop-blur-md border border-white/10"
              >
      ...
      <div className="lg:col-span-7 xl:col-span-8 flex flex-col p-6 md:p-12 lg:p-16 bg-transparent lg:bg-white">
        ...
        <form
          className="flex flex-col flex-1 max-w-md mx-auto w-full pb-4 lg:justify-start lg:gap-8"
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  className="w-full pl-11 pr-4 py-3.5 rounded-xl bg-[#EFEFEF] border border-[#CBCBCB] focus:bg-white focus:border-indigo-400 focus:ring-4 focus:ring-indigo-50 transition outline-none text-sm placeholder-gray-400 text-gray-400"
                />
              </div>
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  value={form.email}
                  onChange={handleChange}
                  className="w-full pl-11 pr-4 py-3.5 rounded-xl bg-[#EFEFEF] border border-[#CBCBCB] focus:bg-white focus:border-indigo-400 focus:ring-4 focus:ring-indigo-50 transition outline-none text-sm placeholder-gray-400"
                />
              </div>
            </div>
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative group">
                  <input
                    ...
                    value={form.password}
                    onChange={handleChange}
                    className="w-full px-4 py-3.5 rounded-xl bg-[#EFEFEF] border border-[#CBCBCB] focus:bg-white focus:border-indigo-400 focus:ring-4 focus:ring-indigo-50 transition outline-none text-sm placeholder-gray-400"
                  />
                  <button
                    type="button"
